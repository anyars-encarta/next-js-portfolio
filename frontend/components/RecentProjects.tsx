        ...
        <div id='projects' className='py-20'>
            ...
            <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
                {projects.map((project) => (
                    <div key={project._id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex flex-col items-center justify-evenly sm:w-[570px] w-[80vw] group'>

                        <PinContainer title={project.projectLink} href={project.projectLink}>
